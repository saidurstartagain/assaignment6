...
const StepCard = ({ number, Icon, title, description, isPlain }) => {
  return (
    <div className="relative p-10 bg-white border border-gray-100 rounded-[2.5rem] shadow-lg shadow-gray-100/50 flex flex-col items-center text-center hover:bg-gray-200">
